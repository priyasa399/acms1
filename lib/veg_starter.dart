...
class Veg_Starter extends StatefulWidget {
  @override
  Veg_StarterState createState() => Veg_StarterState();
}
class Veg_StarterState extends State<Veg_Starter> {
...
children:food.map((food) => fooditem(food)).toList(),
      ...
      body:StreamBuilder(
          stream:Firestore.instance.collection('Veg Starters').snapshots(),
