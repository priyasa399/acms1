...
class Non_Veg_Curries extends StatefulWidget {
  @override
  Non_Veg_CurriesState createState() => Non_Veg_CurriesState();
}
class Non_Veg_CurriesState extends State<Non_Veg_Curries> {
...
children:food.map((food) => fooditem(food)).toList(),
      ...
      body:StreamBuilder(
          stream:Firestore.instance.collection('Non-Veg Curries').snapshots(),
