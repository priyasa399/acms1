...
class Veg_Curries extends StatefulWidget {
  @override
  Veg_CurriesState createState() => Veg_CurriesState();
}
class Veg_CurriesState extends State<Veg_Curries> {
...
children:food.map((food) => fooditem(food)).toList(),
      ...
      body:StreamBuilder(
          stream:Firestore.instance.collection('Veg Curries').snapshots(),
