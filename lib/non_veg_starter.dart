...
class Non_Veg_Starter extends StatefulWidget {
  @override
  Non_Veg_StarterState  createState() =>  Non_Veg_StarterState();
}
class  Non_Veg_StarterState extends State<Non_Veg_Starter> {
...
children:food.map((food) => fooditem(food)).toList(),
      ...
      body:StreamBuilder(
          stream:Firestore.instance.collection('Non-Veg Starters').snapshots(),
